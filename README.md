...
The A/B test results provide strong evidence to reject the null hypothesis.  
Users interacting with the split websites demonstrated higher engagement compared to the combined website.

---

## 💡 Key Insights
- Website traffic is highly **event-driven**  
- Splitting the websites improved **user engagement**  
- Recording Academy users exhibit **longer sessions and lower bounce rates**  
- Mobile users account for a significant portion of traffic (~73.7%)  
...
- ✅ Maintain the split website structure  
- ✅ Continue optimizing each platform for its target audience  
- ✅ Improve mobile experience to further enhance engagement  

The data shows that separating the platforms allows users to access more relevant content, resulting in better overall engagement.
...
## 🔗 Project Files
- 📁 Excel Workbook:  
[Download Project File](Project-Analyzing-Website-Performance-Grammys%20Completed.xlsx)
